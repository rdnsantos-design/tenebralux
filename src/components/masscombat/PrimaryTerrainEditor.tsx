...
import { MassCombatPrimaryTerrain, CLIMATE_OPTIONS, VISIBILITY_OPTIONS, VisibilityLevel } from '@/types/MassCombatTerrain';
import { useCreateMassCombatPrimaryTerrain, useUpdateMassCombatPrimaryTerrain } from '@/hooks/useMassCombatTerrains';
import { toast } from 'sonner';

interface PrimaryTerrainEditorProps {
  terrain?: MassCombatPrimaryTerrain | null;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function PrimaryTerrainEditor({ terrain, open, onOpenChange }: PrimaryTerrainEditorProps) {
  const createTerrain = useCreateMassCombatPrimaryTerrain();
  const updateTerrain = useUpdateMassCombatPrimaryTerrain();
