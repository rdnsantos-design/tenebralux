// ========================
// INSTÂNCIA DE UNIDADE
// Unidade criada a partir de um template, vinculada a um regente
// Pode evoluir, ser alocada em exércitos e receber comandantes
// ========================

import { ExperienceLevel, SpecialAbilityTemplate } from './unit-template';
...
// Pontos de XP necessários para subir de nível
