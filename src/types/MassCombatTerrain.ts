...
export const VISIBILITY_OPTIONS: { value: VisibilityLevel; label: string; modifier: number }[] = [
  ...
  { value: 'encoberto', label: 'Encoberto', modifier: -99 }, // Out of field of view
];
...
export interface MassCombatPrimaryTerrain {
  id: string;
  name: string;
...
export interface MassCombatSecondaryTerrain {
  id: string;
  name: string;
  description: string | null;
...
export interface MassCombatTerrainCompatibility {
  id: string;
...
export const INITIAL_PRIMARY_TERRAINS: Omit<MassCombatPrimaryTerrain, 'id' | 'created_at' | 'updated_at'>[] = [
  {
    name: 'Planície',
...
export const INITIAL_SECONDARY_TERRAINS: Omit<MassCombatSecondaryTerrain, 'id' | 'created_at' | 'updated_at'>[] = [
  {
    name: 'Elevação',
...
// Compatibility map: secondary terrain name -> list of compatible primary terrain names
