/**
 * EDITOR UNIFICADO DE TERRENO SECUNDÁRIO
 * 
 * Usado tanto em Skirmish (características de hex) quanto em Warfare.
 */
...
import { SecondaryTerrain } from './types';
import { useCreateSecondaryTerrain, useUpdateSecondaryTerrain } from './hooks';
import { toast } from 'sonner';

interface SecondaryTerrainEditorProps {
  terrain?: SecondaryTerrain | null;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function SecondaryTerrainEditor({ terrain, open, onOpenChange }: SecondaryTerrainEditorProps) {
  const createTerrain = useCreateSecondaryTerrain();
  const updateTerrain = useUpdateSecondaryTerrain();
