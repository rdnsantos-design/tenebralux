-- CORREÇÃO 1: Integrar finalize_scenario diretamente no resolve_logistics_round
-- Isso evita race conditions entre chamadas RPC separadas
...
DECLARE
  ...
  -- Variáveis para cálculo de VET (antes de limpar bids)
...
BEGIN
  ...
  -- CALCULAR TOTAL GASTO EM LOGÍSTICA AGORA (antes de qualquer limpeza)
  ...
  -- INTEGRAR finalize_scenario AQUI: Atualizar estado com vencedores E orçamento VET
  UPDATE public.match_state
  SET 
    ...
    -- Campos de VET budget calculados
    ...
    -- Limpar estado transitório de logística
